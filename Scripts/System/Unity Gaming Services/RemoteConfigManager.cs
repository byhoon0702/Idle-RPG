...
public class RemoteConfigManager : MonoBehaviour
{
	...
	{
		//RemoteConfigService.Instance.FetchCompleted -= RemoteConfigLoaded;
		string _uuid = PlatformManager.UserDB.userInfoContainer.userInfo.UUID;
		RemoteConfigService.Instance.SetCustomUserID(_uuid);

		await RemoteConfigService.Instance.FetchConfigsAsync(new userAttributes() { userLevel = _userLevel, uuid = _uuid, stageLevel = _stageLevel }, new appAttributes());
	...
	public void SendCouponCode(string coupon)
	{

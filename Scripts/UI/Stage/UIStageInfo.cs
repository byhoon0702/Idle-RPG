...
public class UIStageInfo : MonoBehaviour
{
	...
	{
		_StageManager.it.continueBossChallenge = isTrue;
	}
	...
	{
		var curStage = _StageManager.it.CurrentStage;
		hpSlider.value = 0f;
	...
	public void OnUpdate(RuntimeData.StageInfo _stageInfo)
	{
		...
		toggleContinue.isOn = _StageManager.it.continueBossChallenge;
	}
	...
	public void RefreshKillCount()
	{
        ...
        if (_StageManager.it.CurrentStage.CountLimit > 0)
        {
            if (sb.Length != 0)
            {
                sb.Append("\n");
	...
	{
		var totalDamage = _StageManager.it.cumulativeDamage;
	...
	public void OnClickPlayBoss()
	{
		...
		_StageManager.it.OnClickBoss(_StageManager.it.CurrentStage);

...
public class SkillModule : MonoBehaviour
{
	...
	public SkillSlot currentSlot { get; private set; }
	public HitInfo info { get; private set; }
	...
	Action _onComplete;
	public void RegisterUsingSkill(SkillSlot skillSlot, Action onComplete)
	{
		currentSlot = skillSlot;
		_onComplete = onComplete;
	}
	public void ActivateSkill(SkillSlot skillSlot, Action onComplete)
	{
	...
	public void ActivateSkill()
	{
		...
		currentSlot.Trigger(caster, _onComplete);
		//currentSlot = null;

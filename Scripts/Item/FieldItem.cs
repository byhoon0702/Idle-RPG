...
public class Pool
{
	...
	{
		pool = new ObjectPool<GameObject>(Create, Get, Release, Destroy, maxSize: max);
	...
	protected virtual void Get(GameObject obj)
	{
		obj.SetActive(true);
	}
	protected virtual void Release(GameObject obj)
	{
		obj.SetActive(false);
	}

...
namespace RuntimeData
{
	...
	public class GachaInfo : ItemInfo
	{
		...
		public GachaDataSummonInfo gacha100 { get; private set; }

		public GachaDataSummonInfo gachaTicket10 { get; private set; }
		public GachaDataSummonInfo gachaTicket100 { get; private set; }
		...
		public override void SetRawData<T>(T data)
		{
			...
			{
				var summonInfo = rawData.summonInfos[i];
				if (summonInfo.summonType == GachaButtonType.Gacha10)
				{
					gacha10 = summonInfo;
				}
				if (summonInfo.summonType == GachaButtonType.Gacha100)
				{
					gacha100 = summonInfo;
				}
				if (summonInfo.summonType == GachaButtonType.Ads)
				{
					gachaAds = summonInfo;
				}
				if (summonInfo.summonType == GachaButtonType.Ticket10)
				{
					gachaTicket10 = summonInfo;
				}
				if (summonInfo.summonType == GachaButtonType.Ticket100)
				{
					gachaTicket100 = summonInfo;
				}
		...
		public void OnClickGacha(GachaButtonType type, GachaMethodType methodType)
		{

			var summonInfo = gacha10;
			if (methodType == GachaMethodType.TICKET)
			{
				summonInfo = gachaTicket10;
			}
